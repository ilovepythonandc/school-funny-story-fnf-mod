...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["oh he give up",				"Beat Week school on Hard with no Misses.",			'weekschool_nomiss',	false],
		["God Damn You Beet Me",		"Beat Week me on Hard with no Misses.",				'weekme_nomiss',		false],
