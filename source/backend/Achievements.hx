...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["He's giving up!",			    "Beat Week School on Hard with no Misses.",			'weekshool_nomiss',		false],
		["Oh my god,You defeated me",	"Beat Week me on Hard with no Misses.",				'weekme_nomiss',		false],
