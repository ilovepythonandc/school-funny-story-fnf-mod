...
{
	var options:Array<String> = ['Note Colors', 'Controls', 'Adjust Delay and Combo', 'Graphics', 'Visuals and UI', 'Gameplay', 'Fullscreen Set'];
	...
	function openSelectedSubstate(label:String) {
		switch(label) {
			...
			case 'Fullscreen Set':
				MusicBeatState.switchState(new options.FullscreenSetSubState());
		}
	}
